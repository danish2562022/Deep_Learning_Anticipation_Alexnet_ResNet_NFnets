...
# testing
parser.add_argument('--test_folder', type=str, default='C:/Users/Deep_Learning/Desktop/Dataset_Cholec/ins_ant-master/data/images/output/test')
parser.add_argument('--model_folder', type=str, default='../output/experiments/20210520-020300_horizon5_anticipation/models/')
